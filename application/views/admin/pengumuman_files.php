                            ...
                            <div id="carouselExampleBigIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item active">
                                        <a href="<?=base_url('assets/uploads/pengumuman/'.$e->filename)?>"><?=$e->caption?></a><br>
                                        <a href="<?=site_url('admin/delete_pengumuman_files/'.$e->id_pengumuman_files.'/'.$e->id_pengumuman)?>"><button class="btn">Hapus File</button></a>
                                    </div>
                                        <?php }} ?>
                                </div>
