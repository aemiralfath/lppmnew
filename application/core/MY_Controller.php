...
{
  public $title = 'Lembaga Pengabdian dan Pengembangan Unsri';
   ...
   * @param String letak folder template
	 **/
	public function template($data,$role='user')
	{
		if ($role == 'user') {
			return $this->load->view('portal/template/layout', $data);
		} elseif ($role == 'admin') {
